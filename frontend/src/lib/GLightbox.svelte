    ...
    {:else}
        <div id="glightbox-body" class="glightbox-container glightbox-clean" tabindex="-1" role="dialog" aria-hidden="false">
            ...
            <div class="gcontainer">
                ...
                <button class="gbutton gdownload gbtn" on:click={download} aria-label="Donwload" data-taborder="4">{@html lightbox.settings.svg.download}</button>
                <button class="gclose gbtn" aria-label="Close" data-taborder="3">{@html lightbox.settings.svg.close}</button>
                <button class="gprev gbtn" aria-label="Previous" data-taborder="2">{@html lightbox.settings.svg.prev}</button>
                <button class="gnext gbtn" aria-label="Next" data-taborder="1">{@html lightbox.settings.svg.next}</button>
            </div>
        </div>
    {/if}
{/if}
